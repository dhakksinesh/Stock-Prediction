...
if len(data)==0:
    ...
    if model=='Simple Exponential Smoothing':
        ...
        from s_models import SES_model
        ...
        from s_models import Holt_model
        ...
        from s_models import Holt_Winter_Model
        ...
        from s_models import ARMA_model
        ...
        from s_models import ARIMA_model
        ...
        from s_models import Auto_Arima
